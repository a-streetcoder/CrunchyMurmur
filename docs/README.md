# CrunchyMurmur documentation

This documentation covers installation, day-to-day use, platform differences, development, and publishing.

## Use CrunchyMurmur

- [Getting started](getting-started.md) — install, choose a transcription engine, and make the first dictation.
- [Features and providers](features.md) — dictation, meetings, notes, templates, statistics, and optional AI.
